...
const deleteUserFeedFollow = `-- name: DeleteUserFeedFollow :one
...
func (q *Queries) DeleteUserFeedFollow(ctx context.Context, arg DeleteUserFeedFollowParams) (int32, error) {
	row := q.db.QueryRowContext(ctx, deleteUserFeedFollow, arg.FeedID, arg.UserID)
	var column_1 int32
